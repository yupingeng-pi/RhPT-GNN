...
batch_size = 20
gamma0 = 0.9995 #Learning rate decrease with exponential scheduler
lr0= 0.0005 #Initial learning rate
epochs = 140000

# Penalty multipliers: mun0, muf0, muh0, betaf, betah
penalty_multiplers =  [1, 0.001, 0.1, 1.00002, 1.00003] #These multiplers are generally static except for mun0, which is a balancing term to decide of we want to focus more on cost or eq loss
